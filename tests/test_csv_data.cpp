...
void test_of_init_1() {
    ...
    csvm::CSVData data({{"message", 0}}, {{"text"}});
...
void test_of_init_2() {
    ...
    bool bad = false;
    try {csvm::CSVData data({{"message", 0}}, {{"text", "2"}}); bad = true;} catch (std::invalid_argument) {}
    try {csvm::CSVData data({{"message", 0}, {"2", 1}}, {{"text"}}); bad = true;} catch (std::invalid_argument) {}
...
void test_column_1() {
    ...
    csvm::CSVData data({{"message", 0}, {"thing", 1}}, {{"text1", "text2"}, {"text3", "text4"}});
...
void test_delete_row_2() {
    ...
    csvm::CSVData data({{"message", 0}}, {{"text3"}, {"text5"}, {"who"}});
...
void test_delete_row_3() {
    ...
    csvm::CSVData data({{"message", 0}, {"number", 1}}, {{"text1", "number1"}, {"text2", "number2"}});
...
void test_add_row_1() {
    ...
    csvm::CSVData data({{"message", 0}, {"number", 1}, {"thing", 2}, {"yeah", 3}}, {{"1", "2", "3", "4"}});
...
void test_add_row_3() {
    ...
    csvm::CSVData data({{"message", 0}, {"number", 1}, {"3", 2}}, {{"text1", "number1", "1"}, {"text2", "number2", "2"}});
...
void test_insert_row_1() {
    ...
    csvm::CSVData::vector_s first = {"1", "2", "3", "4"}, last = {"56", "23", "34", "54"};
    std::vector<std::string> row = {"4", "3", "2", "1"};
    std::vector<std::string> blank(4, "");

    csvm::CSVData data({{"message", 0}, {"number", 1}, {"thing", 2}, {"yeah", 3}}, {first, last});
    ...
    if (
        ...
        data[7] != csvm::CSVData::vector_s{"4", "21", "53", "24"} || data[8] != row
...
void test_add_column_1() {
    ...
    csvm::CSVData data({{"message", 0}}, {{"4"}});

    data.add_column("who", "123");

    if (data.get_column_index()["who"] != 1 || data[0] != csvm::CSVData::vector_s{"4", "123"})
